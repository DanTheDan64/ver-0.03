...
var speed = randf_range(lowest_speed, highest_speed)
var max_distance_to_pack = randf_range(lowest_max_distance_to_pack, highest_max_distance_to_pack)
var panic_amount = randf_range(lowest_panic_amount, highest_panic_amount)
